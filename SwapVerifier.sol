...
interface ISimpleSwap {
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut) external view returns (uint256);
...
contract SwapVerifier {
    ...
    function verify(
        ...
        console.log("before initial checks");
        ...
        // Add liquidity
        console.log("before liquitidy call");
        ...
        console.log("before liquidity checks");
        ...
        console.log("before getAmountOut");
        uint256 expectedOut = ISimpleSwap(swapContract).getAmountOut(amountIn, ISimpleSwap(swapContract).reserveA(), ISimpleSwap(swapContract).reserveB());

        // Perform swap
        console.log("before swap amount approve");
        ...
        console.log("before removeLiquidity checks");
        require(aOut + bOut > 0, "removeLiquidity returned zero tokens");

        // Add author
        console.log("before push author");
        authors.push(author);
    }
}